        ...
        return (
            <div className="playlist-grid">
                <h2 style={{ margin: "30px", fontWeight: "bold", color: "white" }}>Playlist
                    <span style={{ marginLeft: "4px", fontSize: "40px" }}><i class="fas fa-music"></i></span>
                    <span style={{ float: "right", fontSize: "0px" }}><button onClick={this.props.reset}style={{background:"black",color:"white",fontSize:"30px",border:"black"}}><i class="fas fa-trash"></i></button></span>
                </h2>
